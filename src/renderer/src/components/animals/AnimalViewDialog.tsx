        ...
        <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
          <div className="space-y-3">
            <div className="relative w-full aspect-square rounded-lg bg-muted overflow-hidden flex items-center justify-center">
              {imageSrc ? (
                <img src={imageSrc} alt={animal?.name || 'Animal'} className="object-cover w-full h-full" />
              ) : (
          ...
          <div className="space-y-2 text-sm">
            <div><span className="text-muted-foreground">Tag:</span> {animal?.tagNumber || '-'}</div>
            <div><span className="text-muted-foreground">Breed:</span> {animal?.breed || '-'}</div>
            <div>
            ...
            <div><span className="text-muted-foreground">Type:</span> {animal?.type?.name || '-'}</div>
            <div>
            ...
            <div>
              ...
              {animal?.acquisitionDate ? new Date(animal.acquisitionDate).toLocaleDateString() : '-'}{' '}
